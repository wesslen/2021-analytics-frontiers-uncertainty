...
### That interval may not mean what you think

### Error bars are not enough

### Pull yourself up from your *bootstraps*

### Turn to the dark side: Bayesian analysis 

### Research from UNCC's Ribarsky Center for Visual Analytics
...
Why Frequentist statistics are confusing
...
A frequentist confidence interval answers the question: “How certain are we that the true parameter value is not zero?”

whereas: A Bayesian credible interval answers the question: “Where do we expect the true parameter value to lie?”
...
[@john_t_ormerod](https://twitter.com/john_t_ormerod/status/1181456582619451392?s=20)
...
.pull-left[
Survey with no progress bar
[insert image]
]
.pull-right[
Survey with "fast-to-slow" progress bar
[insert image]
]

[Villar, Callegaro, and Yang (2013)](https://journals.sagepub.com/doi/10.1177/0894439313497468)
---
...
[insert basic scatter plot]

---

# Correlation judgement

[add left/right of two people who perceive differences; one consumes data while other has conflicting prior beliefs and ignores the correlation]

---

# Bayesian cognitive modeling

[diagram with (1) elicit beliefs (2) user visualizes data (3) update beliefs]

---

```{r, out.width = "500px"}
knitr::include_graphics("./img/linecone.gif")
```
...
<img src="./img/myopic-loss-aversion.png" height=50% width=50%>
...
<img src="./img/myopic-loss-aversion2.png" height=50% width=50%>
...
| Syntax      | R | Python |
| ----------- | ----------- | ----------- |
| Bootstrapping      | `rsample`       | `bootstrap` |
| Bayesian Statistics | `rstan`<br />`brms`<br />`tidybayes`    | `pymc3` |
| Uncertainty Visualizations | `ggdist` | `DABEST` |

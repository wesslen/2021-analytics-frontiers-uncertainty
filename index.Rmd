...
<img src="./img/uncertainty.png" width=650 height=550>
...
Recent advances in communicating uncertainty in the fields human-computer interaction and information visualizations provide ample opportunities to better integrate uncertainty with data science methods to enable better decision-making.

* probabilities are hard => frequency framing and contrual theory

* classic statistics (e.g., p values) are confusing => bootstrapping and animation (e.g., hops)

* mental models are formulated from assumptions augmented by learning through data => Bayesian analysis (e.g., visualizing, estimating models, or cognitive processes)
...
<img src="./img/uncertainty-qual.png" width=100% height=100%>
...
<img src="./img/linecone.gif" width=45% height=45%>

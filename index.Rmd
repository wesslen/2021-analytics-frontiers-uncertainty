...
or even in AI like NLP where state-of-the-art model accuracies like this -- at timeline of models' accuracy in one natural language processing task -- named entity recognition -- on a popular benchmark dataset.

how can we decide with confidence if one model really is better than another one without explicitly considering uncertainty?
...
argument: visualization / hci techniques provide the best way to communicate uncertainty in data science
...
first, we use theories from psychology, cognitive science and behavioral economics to motivate research areas for data visualization. this could cover low level theories of decision-making like perceptual psychology where we're interested in how people perceive form, shape, and animation through low level processes. alternatively, this could also cover theories of higher level process that may require deliberate effort to process difficult information and require a choice of attention and precious processing resources.
